...
python create_dpr_dataset.py create --base-output-dir /home/s1569885/datasets/writing_prompts_dpr/ \
--dataset-name writing_prompts_train_dpr_window_4_step_2_compressed \
--datasets /home/s1569885/datasets/writing_prompts_dpr/WritingPrompts/train.jsonl \
--index-name compressed --index-worlds 32 --window-size 4 --window-step 2
