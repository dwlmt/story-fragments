...
class GlobCorpusOpen(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        GlobInterleavedHfDatasetConfig(name="bookcorpus_context_4_label_1_step_4",
                                       ...
                                       glob_path=_BOOK_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="bookcorpus_context_4_label_4_step_4",
                                       description="Writing Prompts with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
        ...
        GlobInterleavedHfDatasetConfig(name="bookcorpus_context_4_label_4_step_4b",
                                       ...
                                       glob_path=_BOOK_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="bookcorpus_context_4_label_4_step_4_neg",
                                       description="Writing Prompts with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
        ...
        GlobInterleavedHfDatasetConfig(name="schmoop_context_4_label_1_step_4",
                                       ...
                                       glob_path=_BOOK_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="schmoop_context_4_label_4_step_4",
                                       description="Schmoop with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
        ...
        GlobInterleavedHfDatasetConfig(name="schmoop_context_4_label_4_step_4b",
                                       ...
                                       glob_path=_BOOK_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="schmoop_context_4_label_4_step_4_neg",
                                       description="Schmoop with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
        ...
        GlobInterleavedHfDatasetConfig(name="moviecorpus_context_4_label_1_step_4",
                                       ...
                                       glob_path=_MOVIE_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="moviecorpus_context_4_label_4_step_4",
                                       description="Movie script with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
                                       ...
                                       glob_path=_MOVIE_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="moviecorpus_context_4_label_4_step_4b",
                                       description="Movie script with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
                                       ...
                                       glob_path=_MOVIE_CORPUS_GLOB_PATH,
                                       version=_VERSION),
        GlobInterleavedHfDatasetConfig(name="moviecorpus_context_4_label_4_step_4_neg",
                                       description="Movie script with 4 sentence steps.",
                                       input_size=4,
                                       target_size=4,
                                       step_size=4,
