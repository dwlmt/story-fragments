...
class WikiplotsInterleavedDataset(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        WikiPlotsInterleavedHfDatasetConfig(name="wikiplots_context_6_label_6_step_6_neg",
                                            ...
                                            data_download_checksum=_DOWNLOAD_CHECKSUM,
                                            version=_VERSION),
        WikiPlotsInterleavedHfDatasetConfig(name="wikiplots_context_12_label_12_step_12",
                                            description="Wikiplots with one sentence of context, "
                                                        "labels and a one sentence step.",
                                            input_size=12,
                                            target_size=12,
                                            ...
                                            data_download_checksum=_DOWNLOAD_CHECKSUM,
                                            version=_VERSION),
        WikiPlotsInterleavedHfDatasetConfig(name="wikiplots_dummy_12_label_12_step_12",
                                            description="Wikiplots with one sentence of context, "
                                                        "labels and a one sentence step.",
                                            input_size=12,
                                            target_size=12,
