...
from story_fragments.training.deepspeed_utils import DeepspeedConfig
...
class DeepspeedTrainer(Trainer):
    ''' Deepspeed trainer from https://github.com/jacobdanovitch/allennlp_deepspeed/blob/master/allennlp_deepspeed/
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        for batch_group in batch_group_generator_tqdm:
            ...
            if self._master:
                # Updating tqdm only for the master as the training wouldn't have one
    ...
    def from_partial_objects(
        ...
        checkpointer_ = checkpointer.construct() if checkpointer is not None else Checkpointer(serialization_dir)
        tensorboard_writer_ = tensorboard_writer.construct() if tensorboard_writer is not None else TensorboardWriter(serialization_dir)
